namespace PhotosOfUs {
    angular.module('app').controller('UploadProfileImageModalCtrl',
    ['$scope', 'FileUploader', '$window', '$mdDialog', function ($scope, FileUploader, $window, $mdDialog) {
        ...
        $scope.photoNameValidation = function (e, selectedItem) {
            const prohibited = ['drop table', 'alter table', 'create database', 'create table',
                'create view', 'delete from', 'drop database', 'drop index',
