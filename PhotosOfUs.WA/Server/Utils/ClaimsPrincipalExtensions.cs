...
//{
//    public static class PoUClaimsPrincipalExtensions
//    {
//        public new static int Id(this ClaimsPrincipal principal)
//        {
//            var val = principal.FindFirst(x => x.Type == "ID")?.Value;
...
//        public static string AzureID(this ClaimsPrincipal principal) =>
//            principal.Get("http://schemas.microsoft.com/identity/claims/objectidentifier");

//        public static string ProfilePictureUrl(this ClaimsPrincipal principal)
//        {
//            return Get(principal, "ProfilePictureUrl") ?? "";
//        }
